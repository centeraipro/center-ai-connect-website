  ...
  return (
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <motion.div
          className="max-w-4xl mx-auto text-center space-y-8 bg-gradient-to-br from-foreground to-foreground/90 text-background rounded-3xl p-12 md:p-16 relative overflow-hidden"
        ...
        >
          ...
          <motion.p
            className="text-sm opacity-75 pt-4 relative z-10"
            initial={{ opacity: 0 }}
